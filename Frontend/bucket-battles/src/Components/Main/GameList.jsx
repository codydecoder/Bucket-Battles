            ...
            <ul>
                {games.map((game, key) => (
                    <div className="" key={game._id}>
                            <h3 className="text-lg">Game: <span className='text-sm'>{game.homeTeam} vs {game.awayTeam}</span></h3>
                            <h3 className='text-lg'>Winner: <span className='text-sm'>{game.winningTeam}</span></h3>
                    </div>
                ))}
            </ul>
        </div>
